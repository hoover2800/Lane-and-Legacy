...
(async()=>{
 ...
 for(const width of [1440,768,390,320]){
  ...
  await page.goto('http://127.0.0.1:4186/?factory_test=1');await page.waitForSelector('.product-card');
 ...
 await page.reload();await page.waitForSelector('.product-card');assert.equal(await page.locator('.product-card').count(),4);
